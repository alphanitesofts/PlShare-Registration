...
const Register = ({ Code }) => {
  ...
  const submitData = () => {
    ...
    axios
      .post(`${process.env.REACT_APP_BASE_URL}register`, userObj)
      .then((res) => {
  ...
  const sendCode = () => {
    ...
    axios
      .post(`${process.env.REACT_APP_BASE_URL}checkcode`, RefObj)
      .then((res) => {
  ...
  function MyTimer({ expiryTimestamp }) {
    ...
    return (
      <div style={{ textAlign: "center" }}>
        ...
        {isRunning ? (
          <p>We are sending OTP to the provided number</p>
        ) : (
          <>
  ...
  const checkRegisters = () => {
    ...
    axios
      .post(`${process.env.REACT_APP_BASE_URL}check_register`, userObj)
      .then((res) => {
        if (res.data.status === "200") {
          setLoader(false);
        ...
        <>
          <div className="text-center" style={{ marginTop: "6em" }}>
            ...
            <p className="me-3 ms-3">
              Welcome to PL-Share Trading, a platform where you can earn up to
              50k in a month easily! Enter the refer code below to register
      ...
      return (
        <>
          <div className="text-center" style={{ marginTop: "6em" }}>
            <h1>Verification</h1>
            <p className="me-3 ms-3">
              Please Enter the OTP that you have received on your phone number ,
              if you do not received the OTP, you can try again later.
            </p>
          </div>
        </>
      );
                ...
                <div className="center text-white text-center ">
                  ...
                  {!error ? (
                    ...
                    <p className="text-danger mt-1">
                      You added a wrong refferal code, Please verify the
                      provided refferal code
                    </p>
                  )}

                  <p className="mt-3">
                    Promotion offer is only for first 10,000 users, Hurry up
                    only <span style={{ color: "#3EB8B4" }}>9340 </span>/10000
                    registers left.{" "}
                  </p>
                </div>
              </>
                ...
                <div className="card-body">
                  <div className="form-label">
                    ...
                    <div className="input-group">
                      ...
                      >
                        {CountryCode.map((items, i) => {
                          return (
                            <>
                              <option key={i}>{items.code}</option>
                            </>
                          );
                        })}
                      </select>
                  ...
                  <div className="form-label">
                    ...
                    <input
                      ...
                      placeholder="NIC or Passport without dashes"
                      required
                      style={{
                        backgroundColor: "#161616",
                        color: "#F6F6F6",
                    ...
                    {cnicField === true ? (
                      <p className="form-text text-danger">
                        Your NIC or Passport should only be 13 digits
                      </p>
                    ) : null}
                  </div>
                </div>
                  ...
                  <div className="form-label">
                    ...
                    <input
                      ...
                      style={{
                        ...
                        borderRadius: "10PX",
                        borderColor:
                          qstatus === true && answer === "" ? "red" : "#3EB8B4",
                      }}
                      aria-label="Sizing example input"
                      aria-describedby="inputGroup-sizing-lg"
                    />
